...
void parse_and_configure(std::initializer_list<char const*> args) {
    auto const desc = log_cli::get_options_description();

    std::vector<char const *> raw_args{"log_cli_test"};
