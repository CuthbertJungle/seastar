...
std::atomic<lowres_clock_impl::steady_rep> lowres_clock_impl::_steady_now;
std::atomic<lowres_clock_impl::system_rep> lowres_clock_impl::_system_now;
...
void lowres_clock_impl::update() {
    ...
    _steady_now.store(steady_count, std::memory_order_relaxed);
    _system_now.store(system_count, std::memory_order_relaxed);
}
